...
function chargeCreditCard($validated)
{
    $amount = '5.00';
    /* Create a merchantAuthenticationType object with authentication details
       retrieved from the constants file */
    $merchantAuthentication = new AnetAPI\MerchantAuthenticationType();
    $merchantAuthentication->setName('8e8NaEz2Mnzg'); // LOGIN ID
    $merchantAuthentication->setTransactionKey('5EpT6Z9z5LF7a6kg'); // TRANSACTION KEY
