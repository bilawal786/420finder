    ...
    <section class="mt-5 pt-5" style="background-image: url({{ asset('images/business/bg.png')}}),linear-gradient(161deg,#004443 0%,#00afa7 100%)!important;padding-bottom: 0px;">
        ...
        <div class="container mt-4 pt-5">
            ...
            <div class="row py-5">
                ...
                <div class="col-md-6">
                    <h1 class="text-white">Reach more active cannabis consumers</h1>
                    <p class="text-white">
                        There are more active cannabis consumers on Weedmaps® than anywhere else. Get in front of them when they’re researching products from brands and shops like yours.
                    </p>
                    <div class="forMobile">
                ...
                <div class="col-md-6 mb-5 bg-white">
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <h4 class="pt-3"><strong>Over 7 minutes</strong></h4>
                            <p>Average time spent per session in the Weedmaps app.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row pb-5">
                <div class="col-md-4 pt-5">
                    ...
                    <h4 class="text-white pt-3"><strong>Build your brand</strong></h4>
                    <p class="text-white">Elevate your brand message and drive more awareness.</p>
                </div>
                <div class="col-md-4 pt-5">
                    <img src="{{ asset('images/reachnewcustomers.png') }}" style="width: 15%;">
                    <h4 class="text-white pt-3"><strong>Reach new customers</strong></h4>
                    <p class="text-white">Drive active consumers in your area to your business page.</p>
                </div>
                <div class="col-md-4 pt-5">
                    <img src="{{ asset('images/marketmorecosteffectively.png') }}" style="width: 15%;">
                    <h4 class="text-white pt-3"><strong>Market more cost-effectively</strong></h4>
                    <p class="text-white">Competitive ad rates vs. industry average.</p>
                </div>
            </div>
        </div>
    </section>
