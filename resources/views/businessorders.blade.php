    ...
    <section class="mt-5 pt-5" style="background-image: url({{ asset('images/business/bg.png')}}),linear-gradient(161deg,#004443 0%,#00afa7 100%)!important;padding-bottom: 0px;">
        ...
        <div class="container mt-4 pt-5">
            ...
            <div class="row py-5">
                ...
                <div class="col-md-6">
                    <h1 class="text-white">Turn traffic into orders</h1>
                    <p class="text-white">
                        Get delivery and pickup orders from your page, and manage them with an easy fulfillment platform.
                    </p>
                    <div class="forMobile">
                ...
                <div class="col-md-6 mb-5 bg-white">
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <h4 class="pt-3"><strong>Over 1 million</strong></h4>
                            <p>Orders placed on Weedmaps</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row pb-5">
                <div class="col-md-6 pt-5">
                    <img src="{{ asset('images/buildyourbrand.png') }}" style="width: 10%;">
                    <h4 class="text-white pt-3"><strong>Consumers love convenience</strong></h4>
                    <p class="text-white">Pages with WM Orders stand out and get in front of more active consumers.</p>
                </div>
                <div class="col-md-6 pt-5">
                    <img src="{{ asset('images/reachnewcustomers.png') }}" style="width: 10%;">
                    <h4 class="text-white pt-3"><strong>Easy to get started</strong></h4>
                    <p class="text-white">Orders works seamlessly with your page and embeddable menus, so you can quickly start getting orders.</p>
                </div>
            </div>
        </div>
    </section>
