<template>
     <div class="mobile-v-form">
            <div class="row search-logo-wrap v-mobile-pad">
                ...
                <div class="col-4">
                    <div class="logo-btn">
                        <img :src="logo" alt="Search Menu Logo">
                    </div>
                </div>
                <div class="col-4">
            ...
            <div class="form-wrap search-menu-form v-mobile-pad">
                <form action="">
                    <div class="product-search">
                        <input type="text" name="" placeholder="Products, retailors, brands and more" class="search-menu-form-input" autocomplete="off" v-model="searchQuery" @focus="productSearch = true">
                    </div>
                </form>
                ...
                <form action="">
                    <div class="location-search v-location-search" id="mobileLocationBox">
                        <!-- <input type="text" name="" placeholder="Los Angeles, CA" class="search-menu-form-input" id="mobile_search_input" ref="autocomplete"> -->
                         <input type="text" name="" placeholder="Los Angeles, CA" class="search-menu-form-input" v-model="geometrySearch" @focus="emptyValue">
                    </div>
                </form>
            </div>
            ...
            <div class="v-product-results" v-if="productSearch">
                ...
                <div v-else>
                    ...
                    <div v-else-if="searchQuery.length >= 3 && searchResult.length < 1 && !loading" class="no-result-content">
